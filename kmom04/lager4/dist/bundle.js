...
let lager = {
    ...
    loadAllDeliveries: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            method: "GET",
            url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/deliveries?api_key=${_vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey}`
        }).then(function(result) {
            lager.current.deliveries = result.data;
        }).finally (function() {
            mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
                method: "GET",
                url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/products?api_key=${_vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey}`
            }).then(function(result) {
    ...
    addIndelivery: function() {
        lager.currentForm.api_key = _vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey;
        console.log("lager.currentForm: ", lager.currentForm);

        return mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            method: "POST",
            url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/deliveries`,
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
                method: "PUT",
                url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/products`,
                body: requestBody
...
let home = {
    view: function() {
        ...
        return [
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", timeOfDayGreeting),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("img", image, timeOfDayGreeting)
        ];
    }
};
...
/* harmony import */ var _views_indelivery_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/indelivery.js */ "./js/views/indelivery.js");
/* harmony import */ var _views_new_indelivery_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/new-indelivery.js */ "./js/views/new-indelivery.js");
/* jshint esversion: 8 */
/* jshint node: true */
...
mithril__WEBPACK_IMPORTED_MODULE_0___default().route(document.body, "/", {
    ...
    "/indelivery": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_layout_js__WEBPACK_IMPORTED_MODULE_1__.layout, mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_indelivery_js__WEBPACK_IMPORTED_MODULE_3__.indelivery));
        }
    },
    "/new-indelivery": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_layout_js__WEBPACK_IMPORTED_MODULE_1__.layout, mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_new_indelivery_js__WEBPACK_IMPORTED_MODULE_4__.newIndelivery));
        }
    }
});
